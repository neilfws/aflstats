...
![](swans_alltime_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
Let's start with a boxplot of height by decade that players debuted. ![](swans_alltime_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
The same analysis for weight. Obviously taller players are also heavier. ![](swans_alltime_files/figure-markdown_github/unnamed-chunk-9-1.png)

Median weight has increased from 77 kg for players debuting in the 1890s to 85 kg this decade.

For a bit of fun, we can calculate body mass index (BMI). For normal people values greater than 25 are considered overweight, so we'll colour those values. ![](swans_alltime_files/figure-markdown_github/unnamed-chunk-10-1.png)

Athletes are not normal people, since muscle contributes much more to their body mass. Several versions of a BMI calculation modified for athletes have been proposed, including this one. ![](swans_alltime_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
Let's look at debut age by debut decade. ![](swans_alltime_files/figure-markdown_github/unnamed-chunk-16-1.png)
...
Who gets what number is clearly a complex business with many factors at play. We can see that most Swans numbers fall into two main blocks, with usage dropping away from around number 34 and up. ![](swans_alltime_files/figure-markdown_github/unnamed-chunk-22-1.png)
...
![](swans_alltime_files/figure-markdown_github/unnamed-chunk-25-1.png)

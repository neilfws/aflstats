...
## 1. Getting the data
Data for all Swans games by season are obtained from [AFL Tables](https://afltables.com/afl/teams/swans/allgames.html). The functions used are shown at the end of this document.

```{r warning=FALSE, message=FALSE}
source("../../../R/scripts/afltables.R")
...
# get the home games since moving to Sydney
